...
local workspaces = {
    ...
    { key = "I", id = 4,  run = "librewolf"  },  -- FRFX/LBRW
...
hl.bind(SUPER .. " + SHIFT + F23", hl.dsp.submap("submap-root"))

local transitioning = false

hl.define_submap("submap-root", function()
    hl.bind("w", function()
        transitioning = true
        hl.dispatch(hl.dsp.submap("nav-move"))
    end)
    hl.bind("M", function()
        transitioning = true
...
hl.bind("SUPER + code:48", function()
    ...
    hl.dispatch(hl.dsp.exec_cmd([[/home/alex/.config/kitty/scripts/kitty-topslide.sh]]))
